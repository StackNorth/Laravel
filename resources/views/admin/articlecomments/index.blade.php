                        ...
                        <table class="table table-striped">
                            ...
                            @foreach ($comments as $comment)
                                <tr class="row">
                                    ...
                                    <td class="col-lg-1">
                                        <a href="{{ URL('admin/articlecomment/'.$comment->id.'/edit') }}" class="btn btn-success">编辑</a>
                                    </td>
                                    <td class="col-lg-1">
                                        <form action="{{ URL('admin/articlecomment/'.$comment->id) }}" method="POST" style="display: inline;">
